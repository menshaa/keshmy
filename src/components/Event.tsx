import { Box, Flex, Text, Spacer, HStack, VStack, Icon, Button, Badge, useDisclosure } from "@chakra-ui/react";
...
interface EventProps {
    ...
    interest: number;
    mutateEvents: KeyedMutator<GetEventsRes[]> | KeyedMutator<GetEventsRes> | KeyedMutator<SearchAllRes>;
}
...
export default function Event({
    ...
    return (
        ...
        >
            ...
            <EventModal isOpen={isOpen} onClose={onClose} event={{
                id,
                title,
                description,
                interest,
