        ...
        <AlertDialog isOpen={isOpen} leastDestructiveRef={cancelRef} onClose={onClose}>
            <AlertDialogOverlay>
                <AlertDialogContent bgColor="bgMain">
                    ...
                    <AlertDialogFooter>
                        <ButtonGroup>
                            <Button colorScheme="grey" color="text" ref={cancelRef} onClick={onClose}>Cancel</Button>
                            <Button colorScheme={props.btnColor} onClick={handleConfirmation}>{props.confirmationBtnTitle}</Button>
                        </ButtonGroup>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialogOverlay>
