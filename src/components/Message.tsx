        ...
        <>
            {props.userOwned ? (
                <Flex width="full" justifyContent="flex-end" py={4}>
                    <HStack align="start" maxWidth={{ base: "80%", md: "65%" }}>
                        <VStack spacing={0.5} align="end">
                            ...
                            <VStack spacing={4} alignItems="flex-start" px={4} py={2} bgColor="bgSecondary" rounded="8px 0 8px 8px">
                                {props.attachmentURL ? (
                                    <Image
                                ...
                                <Text fontSize="sm" wordBreak="break-word" whiteSpace="break-spaces">
                                    {props.content}
                                </Text>
                            </VStack>
                        </VStack>
                        <VStack spacing={0.5} align="start">
                            <Avatar src={user?.avatarURL} rounded="lg" width="35px" height="35px" />
                ...
                <HStack align="start" maxWidth={{ base: "80%", md: "65%" }} py={4}>
                    <Avatar src={props.recipientAvatarURL ?? ""} rounded="lg" width="35px" height="35px" />
                    <VStack spacing={0.5} align="start">
                        <MessageTime date={props.createdAt} />
                        <VStack spacing={4} alignItems="start" px={4} py={2} bgColor="bgSecondary" rounded="0 8px 8px 8px">
                            {props.attachmentURL ? (
                                <Image
                                    src={props.attachmentURL}
                                    alt="Message attachment"
