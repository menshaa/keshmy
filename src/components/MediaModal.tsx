import { Icon, IconButton, LightMode, Modal, ModalContent, ModalOverlay, Image as ChakraImage } from "@chakra-ui/react";
...
export default function MediaModal({ isOpen, onClose, ...props }: MediaModalProps) {
    return (
