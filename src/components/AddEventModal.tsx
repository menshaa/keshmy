...
export default function AddEventModal({
    ...
    const [eventDate, setEventDate] = useState<Date | null>(new Date(Date.now() + 3600 * 24 * 1000));
    ...
    const handleSubmit = () => {
        ...
        axiosAuth.post<GenericBackendRes>("events/add-event", payload)
            .then((res) => {
            ...
            .catch((e: AxiosError<GenericBackendRes>) => {
                toast.error(e.response?.data?.message ?? "An error occurred while submitting the event");
                setSubmitting(false);
            });
    };
            ...
            <ModalContent bgColor="bgMain">
                ...
                <ModalBody>
                    <VStack width="full" align="end" spacing={5}>
                        ...
                        <Button colorScheme="green" isLoading={isSubmitting} loadingText="Submitting" onClick={handleSubmit}>
                            Add
                        </Button>
                    </VStack>
                </ModalBody>
