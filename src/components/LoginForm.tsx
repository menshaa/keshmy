...
const TwoFAModal = ({ isOpen, onClose }: TwoFAModalProps): ReactElement => {
    ...
    const handleSubmit = () => {
        ...
        axiosNoAuth.post<GenericBackendRes>("settings/verify-totp-code", { passcode })
            .then((res) => {
            ...
            <ModalContent bgColor="bgMain" pb={5}>
                ...
                <ModalBody>
                    <VStack width="full" alignItems="start" spacing={4}>
                        ...
                        <Input placeholder="6-digit two-factor authentication code" onChange={(e) => setPasscode(e.target.value)} />
                        <Button colorScheme="accent" disabled={isDisabled} isLoading={isSubmitting} loadingText="Verifying" onClick={handleSubmit}>Verify</Button>
                    </VStack>
                </ModalBody>
            </ModalContent>
        </Modal>
...
export default function LoginForm(): ReactElement {
    ...
    const handleSubmit = () => {
        ...
        axiosNoAuth.post<LoginRes>("users/login", form)
            .then((res) => {
    ...
    return (
        <Stack spacing={10} p={5} rounded="4px" bgColor="bgPrimary">
            ...
            <VStack spacing={5} align="stretch">
                <Input placeholder="Username or Email" name="username" withLabel="Username or Email" onChange={handleChange} />
                <Input
            ...
            <VStack align="start">
                ...
                <Button alignSelf="stretch" isLoading={isSubmitting} loadingText="Logging in" disabled={isDisabled} colorScheme="button" onClick={handleSubmit}>
                    Log in
                </Button>
            </VStack>
