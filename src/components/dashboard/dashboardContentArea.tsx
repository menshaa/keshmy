...
export default function DashboardContentArea({ item }: DashboardContentAreaProps): ReactElement {
    const router = useRouter();

    return (
        <VStack spacing={5} width="full">
            <HStack width="full" borderBottom="1px solid var(--chakra-colors-bgSecondary)" borderColor="inherit">
                <IconButton
                    variant="ghost"
