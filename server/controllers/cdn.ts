...
export function getCafeteriaItemImage(req: Request, res: Response) {
  return res.sendFile(
    `cdn/cafeteria/${encodeURIComponent(req.params.fileName)}`,
    { root: `${__dirname}/../` }
  );
}
...
export function getPostImages(req: Request, res: Response) {
  return res.sendFile(`cdn/posts/${req.params.postId}/${req.params.fileName}`, {
    root: `${__dirname}/../`,
  });
}
...
export function getAnnouncementImage(req: Request, res: Response) {
  return res.sendFile(
    `cdn/announcements/${req.params.announcementId}/${req.params.fileName}`,
    { root: `${__dirname}/../` }
  );
}
